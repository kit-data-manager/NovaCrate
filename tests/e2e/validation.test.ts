...
test("Basic validation functionality", async ({ page }) => {
    ...
    await page.getByPlaceholder("Search...").fill("license")
    await page.getByLabel("Suggestions").getByText("License", { exact: true }).click()
    await page.getByLabel("Suggestions").getByText("Text", { exact: true }).click()
