...
![Figure showing how to open the AI Assistant settings and hot to add a new provider](./figures/ai-assistant-setup/initial-settings.png)
...
4. Click on the "Add Provider" button. You should now see the following popup:
    ...
    ![Figure showing the "Configure AI Assistant" model, explained in steps 5 to 10](./figures/ai-assistant-setup/pre-model-fetch.png)
...
10. The models available to the AI Assistant are configured here. It is recommended to fetch these models automatically using the provided button. For this to work, you need to complete the steps above (select a provider and provide an API Key).
   ...
   ![Figure showing the "Configure AI Assistant" model, explained in steps 11 to 12](./figures/ai-assistant-setup/post-model-fetch.png)
